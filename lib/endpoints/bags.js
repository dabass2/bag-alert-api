...
function check_alert() {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const alert_duirng_current_hour = confirmed_bag_alerts.includes(mapped_current_hour)
      ...
      const is_bag_alert = alert_duirng_current_hour || alert_during_current_minute || alert_during_current_second
